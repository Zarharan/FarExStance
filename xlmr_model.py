...
model = TransformerWithExtraFeatures(transformer_params['model_loader'] 
      ,transformer_params['transformer_model_path'], dens_input_size= [first_dense_input_size, 128, 32]
      , extra_features_no= extra_features_no, num_classes=4, dens_dropout=[0.4, 0.3])
